const Committees = () => {
    return (
        <div className="committees">
            Committees (Swedish: <em>nämnder</em>) are groups inside the chapter that dedicate themselves to some part of chapter life, such as
            ...
            <em>The following committees are shared between both the Computer Science chapter and the Media Technology chapter. Students from both chapters can participate!</em>
